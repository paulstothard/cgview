...
Here is the map generated by the above commands (the staggered divider lines show the boundaries of contigs--to use regular divider lines add `-show_contigs F` to the first command):
